import "./images.css"
import Bhubaneshwar from "../../Images/bhubaneswar- odisha.jpg"
import Chandipur from "../../Images/chandipur-beach - odisha.jpg"
import JagannathTemple from "../../Images/jagannath temple - odisha.jpg"
import Hirakud from "../../Images/hirakud dam - odisha.jpg"
import Lingaraja from "../../Images/lingaraja-temple - odisha.jpg"
const Odisha = () => {
  return (
    <div>
        <h1>Odisha</h1>
        <p>Odisha- the land of paddy fields and palm-fringed silver beaches, temples, rivers, waterfalls and tribal people, is filled with major attractions such as the temples of Bhubaneshwar and Puri, miles of clean beaches and the magnificent Sun Temple of Konark.
...
Apart from many of the popular things to buy from Odisha are Jewelers made of metal, Hand paintings, Handcrafted wooden items, Silver filigree items, Sambalpuri dress materials, Handlooms, Stone carvings, different silk sarees and Rasagolla, Fresh river Fish & chenna poda if you are a foodie.
</p>
        <div className="featured">
        <div className="featuredItem">
            <img src={Bhubaneshwar} alt="" className="featuredImg" />
        ...
        <div className="featuredItem">
            <img src={Chandipur} alt="" className="featuredImg" />
            <div className="featuredTitle">
                <h1>Chandipur</h1>
            </div>
        </div>
        <div className="featuredItem">
            <img src={JagannathTemple} alt="" className="featuredImg" />
            <div className="featuredTitle">
                <h1>Jagannath</h1>
                <h1>Temple</h1>
            </div>
        ...
        <div className="featuredItem">
            <img src={Hirakud} alt="" className="featuredImg" />
            <div className="featuredTitle">
                <h1>Hirakud</h1>
            </div>
        </div>
        <div className="featuredItem">
            <img src={Lingaraja} alt="" className="featuredImg" />
            <div className="featuredTitle">
                <h1>Lingaraja</h1>
                <h1>Temple</h1>
            </div>
