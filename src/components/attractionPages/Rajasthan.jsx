...
This historic city formed a part of Harsha Vardhan's empire during which the Chinese traveller Fa-Hien visited India. The King of Jaipur, Raja Man Singh conquered Tari and Tokra Janpad, during the Akbar regime. 12 villages of Tokra Janpad were given away to Bhola Brahmin in the year 1643. Later, the name 'Tonk' was given to these twelve villages by Bhola</p>
    </div>
  )
}
