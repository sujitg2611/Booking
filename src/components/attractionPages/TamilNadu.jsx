import "./images.css"
import Coimbatore from "../../Images/coimbatore- tamil nadu.webp"
import Kodikanal from "../../Images/kodikanal - tamil nadu.jpg"
import Pondicherry from "../../Images/pondicherry - tamil nadu.webp"
...
The township of Pondicherry is planned on a grid system, which is to say that the roads meet each other at right angles. On the seaward side is the long Petit Canal which divides the town so that the French township is on the side facing the sea and the predominantly Indian/Tamil one on the other.</p>
        <p>4.Ooty - tamil nadu
...
Be it summer, monsoon or winter, Ooty will enthral you with the natural grandeur of the mountains and the hospitality of its residents. Being a cherished tourist destination for many, Ooty has got excellent connectivity with the cities and towns in the neighbourhood.</p>
